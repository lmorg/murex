...
func init() {
	Summary = map[string]string{
		...
		"commands/!":                      "Reads the STDIN and exit number from previous process and not's it's condition",
		"commands/(":                      "Write a string to the STDOUT without new line",
		"commands/2darray":                "Create a 2D JSON array from multiple input sources",
		"commands/(murex named pipe)":     "Reads from a Murex named pipe",
		"commands/<stdin>":                "Read the STDIN belonging to the parent code block",
		"commands/=":                      "Evaluate a mathematical function (deprecated)",
		"commands/>>":                     "Writes STDIN to disk - appending contents if file already exists",
		"commands/>":                      "Writes STDIN to disk - overwriting contents if file already exists",
		"commands/autoglob":               "Command prefix to expand globbing (deprecated)",
		"commands/[[":                     "Outputs an element from a nested structure",
		"commands/[":                      "Outputs an element from an array, map or table",
		"commands/@[":                     "Outputs a ranged subset of data from STDIN",
		...
		"commands/null":                   "null function. Similar to /dev/null",
		...
		"user-guide/module":               "An introduction to Murex modules and packages",
		...
		"user-guide/hotkeys":              "A list of all the terminal hotkeys and their uses",
	...
	Synonym = map[string]string{
		...
		"commands/(murex named pipe)":     "commands/(murex named pipe)",
		"commands/<>":                     "commands/(murex named pipe)",
		"commands/read-named-pipe":        "commands/(murex named pipe)",
		"commands/<stdin>":                "commands/<stdin>",
		"commands/=":                      "commands/=",
		"commands/>>":                     "commands/>>",
		"commands/fappend":                "commands/>>",
		"commands/>":                      "commands/>",
		...
		"user-guide/module":               "user-guide/module",
		"user-guide/modules":              "user-guide/module",
		"user-guide/package":              "user-guide/module",
		"user-guide/packages":             "user-guide/module",
		...
		"user-guide/hotkeys":              "user-guide/hotkeys",
