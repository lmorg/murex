...
func init() {
	Summary = map[string]string{
		...
		"parser/multiply-by":               "Multiplies a variable by the right hand value",
		"parser/multiplication":            "Multiplies one numeric value with another",
		"parser/add-with":                  "Adds the right hand value to a variable",
		"parser/addition":                  "Adds two numeric values together",
		"parser/subtract-by":               "Subtracts a variable by the right hand value",
		"parser/pipe-arrow":                "Pipes STDOUT from the left hand command to STDIN of the right hand command",
		"parser/subtraction":               "Subtracts one numeric value from another",
		"parser/divide-by":                 "Divides a variable by the right hand value",
		"parser/division":                  "Divides one numeric value from another",
		...
		"parser/greater-than":              "Writes STDIN to disk - overwriting contents if file already exists",
