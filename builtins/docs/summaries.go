...
func init() {
	Summary = map[string]string{
		...
		"parser/not":                       "Reads the STDIN and exit number from previous process and not's it's condition",
		...
		"parser/brace-quote":               "Write a string to the STDOUT without new line",
