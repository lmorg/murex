...
func init() {
	Summary = map[string]string{
		...
		"equ":                       "Evaluate a mathematical function (deprecated)",
		"greater-than-greater-than": "Writes STDIN to disk - appending contents if file already exists",
		"greater-than":              "Writes STDIN to disk - overwriting contents if file already exists",
		"autoglob":                  "Command prefix to expand globbing (deprecated)",
		"element":                   "Outputs an element from a nested structure",
		"item-index":                "Outputs an element from an array, map or table",
		...
		"commands/not":                       "Reads the STDIN and exit number from previous process and not's it's condition",
		"commands/brace-quote":               "Write a string to the STDOUT without new line",
		...
		"commands/equ":                       "Evaluate a mathematical function (deprecated)",
		"commands/greater-than-greater-than": "Writes STDIN to disk - appending contents if file already exists",
		"commands/greater-than":              "Writes STDIN to disk - overwriting contents if file already exists",
		"commands/autoglob":                  "Command prefix to expand globbing (deprecated)",
		"commands/element":                   "Outputs an element from a nested structure",
		"commands/item-index":                "Outputs an element from an array, map or table",
		"commands/range":                     "Outputs a ranged subset of data from STDIN",
		...
		"commands/cast":                      "Alters the data type of the previous function without altering it's output",
		...
		"commands/try":                       "Handles errors inside a block of code",
		"commands/trypipe":                   "Checks state of each function in a pipeline and exits block on error",
		...
		"parser/string":                      "Expand values as a string",
		...
		"user-guide/spellcheck":              "How to enable inline spellchecking",
	...
	Synonym = map[string]string{
		...
		"fappend":               "greater-than-greater-than",
		">":                     "greater-than",
		"fwrite":                "greater-than",
		"autoglob":              "autoglob",
		"[[":                    "element",
		...
		"commands/=":                      "commands/equ",
		"commands/>>":                     "commands/greater-than-greater-than",
		"commands/fappend":                "commands/greater-than-greater-than",
		"commands/>":                      "commands/greater-than",
		"commands/fwrite":                 "commands/greater-than",
		"commands/autoglob":               "commands/autoglob",
		"commands/[[":                     "commands/element",
		"commands/element":                "commands/element",
		"commands/[":                      "commands/item-index",
		"commands/![":                     "commands/item-index",
		"commands/index":                  "commands/item-index",
		"commands/@[":                     "commands/range",
		...
		"user-guide/not":                  "user-guide/bang-prefix",
		...
		"user-guide/repl":                 "user-guide/job-control",
		"user-guide/readline":             "user-guide/job-control",
		...
		"user-guide/special":              "user-guide/reserved-vars",
		...
		"user-guide/spellcheck":           "user-guide/spellcheck",
