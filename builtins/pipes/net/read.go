...
// ReadArrayByType treats net Io interface as an array of data
func (n *Net) ReadArrayByType(callback func([]byte, string)) error {
	return stdio.ReadArrayByType(n, callback)
}
