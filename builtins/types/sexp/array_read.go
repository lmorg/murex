...
func readArrayWithTypeC(ctx context.Context, read stdio.Io, callback func(any, string)) error {
	return readArrayWithType(ctx, read, callback, true, sexpr)
}
func readArrayWithTypeS(ctx context.Context, read stdio.Io, callback func(any, string)) error {
	return readArrayWithType(ctx, read, callback, false, sexpr)
}

func readArrayWithType(ctx context.Context, read stdio.Io, callback func(any, string), canonical bool, dataType string) error {
	b, err := read.ReadAll()
	if err != nil {
		return err
	}
