<template><div><h1 id="select-optional-command-reference" tabindex="-1"><a class="header-anchor" href="#select-optional-command-reference" aria-hidden="true">#</a> <code v-pre>select</code> - Optional Command Reference</h1>
<blockquote>
...
<pre><code>» ps aux -&gt; select count(*), user GROUP BY user ORDER BY 1
count(*) USER
1       _analyticsd
1       _applepay
1       _atsserver
...
<p>(See below for how to use <code v-pre>config</code>)</p>
