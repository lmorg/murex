<template><div><h1 id="append-file" tabindex="-1"><a class="header-anchor" href="#append-file" aria-hidden="true">#</a> <code v-pre>&gt;&gt;</code> (append file)</h1>
<blockquote>
<p>Writes STDIN to disk - appending contents if file already exists</p>
</blockquote>
<h2 id="description" tabindex="-1"><a class="header-anchor" href="#description" aria-hidden="true">#</a> Description</h2>
<p>Redirects output to file.</p>
<p>If a file already exists, the contents will be appended to existing contents.
Otherwise a new file is created.</p>
<h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2>
<pre><code>`&lt;stdin&gt;` &gt;&gt; filename
</code></pre>
<h2 id="examples" tabindex="-1"><a class="header-anchor" href="#examples" aria-hidden="true">#</a> Examples</h2>
<pre><code>g * &gt;&gt; files.txt
</code></pre>
<h2 id="synonyms" tabindex="-1"><a class="header-anchor" href="#synonyms" aria-hidden="true">#</a> Synonyms</h2>
<ul>
<li><code v-pre>&gt;&gt;</code></li>
<li><code v-pre>fappend</code></li>
</ul>
...
<li><RouterLink to="/commands/tmp.html"><code v-pre>tmp</code></RouterLink>:
Create a temporary file and write to it</li>
</ul>
</div></template>
