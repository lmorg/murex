<template><div><h1 id="marshal-type" tabindex="-1"><a class="header-anchor" href="#marshal-type" aria-hidden="true">#</a> <code v-pre>Marshal()</code> (type)</h1>
<blockquote>
...
The marshal function takes in a Go (golang) <code v-pre>type</code> or <code v-pre>struct</code> and returns
a byte slice of a &quot;string&quot; representation of that format (eg in JSON) or an
error.</p>
<p>This marshaller is then registered to Murex inside an <code v-pre>init()</code> function
and Murex builtins can use that marshaller via the <code v-pre>MarshalData()</code> API.</p>
<h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2>
<p>Registering <code v-pre>Marshal()</code> (for writing builtin data-types)</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>Using an existing marshaller (eg inside a builtin command)</p>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token comment">// See documentation on lang.MarshalData for more details</span>
