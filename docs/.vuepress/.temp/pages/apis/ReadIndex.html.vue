<template><div><h1 id="readindex-type" tabindex="-1"><a class="header-anchor" href="#readindex-type" aria-hidden="true">#</a> <code v-pre>ReadIndex()</code> (type)</h1>
<blockquote>
<p>Data type handler for the index, <code v-pre>[</code>, builtin</p>
</blockquote>
...
<p>Registering your <code v-pre>ReadIndex()</code></p>
...
<p>Example <code v-pre>ReadIndex()</code> function:</p>
