<template><div><h1 id="lang-arraywithtypetemplate-template-api" tabindex="-1"><a class="header-anchor" href="#lang-arraywithtypetemplate-template-api" aria-hidden="true">#</a> <code v-pre>lang.ArrayWithTypeTemplate()</code> (template API)</h1>
<blockquote>
...
<li><code v-pre>func(interface{}, string)</code>: callback function to write each array element, with data type</li>
</ol>
