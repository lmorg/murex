<template><div><h1 id="single-quote-token" tabindex="-1"><a class="header-anchor" href="#single-quote-token" aria-hidden="true">#</a> Single Quote (<code v-pre>'</code>) Token</h1>
<blockquote>
<p>Initiates or terminates a string (variables not expanded)</p>
</blockquote>
<h2 id="description" tabindex="-1"><a class="header-anchor" href="#description" aria-hidden="true">#</a> Description</h2>
<p>Single quote is used to initiate and terminate strict strings where variables
cannot be expanded.</p>
<p>Commands can also be quoted using single quotes (eg where a command might
contain a space character in it's name)</p>
