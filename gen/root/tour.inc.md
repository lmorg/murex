...
* `g`  - traditional globbing                      ({{ link "read more" "g" }})
...
`foreach` allows you to easily iterate through an array or list of any type: ({{ link "read more" "foreach" }})
```
